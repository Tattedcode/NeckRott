...
struct ChinTuckInstructionView: View {
    // MARK: - Properties
    
    /// The chin tuck exercise being displayed
    ...
    private var imagesSection: some View {
        HStack(spacing: 0) {
            ...
            // First instruction image - chintuck1.png
            Image("chintuck1")
                .resizable()
            ...
            // Second instruction image - chintuck2.png
            Image("chintuck2")
                .resizable()
                .aspectRatio(contentMode: .fit)
                .frame(maxHeight: 300)
...
#Preview {
    NavigationStack {
        ChinTuckInstructionView(
            exercise: Exercise(
                title: "Chin Tuck",
                description: "The chin tuck is one of the most effective exercises for correcting forward head posture. This simple yet powerful exercise helps realign the head over the shoulders by strengthening the deep cervical flexors.",
                instructions: [
